...
<div class="space-y-3 rounded-xl border border-[#E7E5E4] bg-[#FCFBFA] p-4">
	<h3 class="text-sm font-semibold tracking-wide text-[#1C1917] uppercase">Tipos disponibles</h3>
